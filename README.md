...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/icy-limit-5045)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/icy-limit-5045
```

A live public deployment of this template is available at [https://icy-limit-5045.templates.workers.dev](https://icy-limit-5045.templates.workers.dev)
